...
// 			mobile: { range: "-150", containers: "fluid", lockViewport: false, grid: { collapse: false } }			// 'mobile-narrow': { range: '-480', grid: { collapse: true, gutters: 10 } }
				...
				// Generic sections.
					$('.main.style1')
						.scrollwatch({
							...
							range:		0.6,
							anchor:		'center',
							off:			function(t) { t.removeClass('inactive'); },
							on:		function(t) { t.addClass('inactive'); }
						});
